...
- [x] CHK057 - Are accessibility requirements specified for keyboard-only navigation? [Completeness, NFR, Spec §FR-031]
- [x] CHK058 - Are accessibility requirements specified for screen reader compatibility? [Completeness, NFR, Spec §FR-032]
